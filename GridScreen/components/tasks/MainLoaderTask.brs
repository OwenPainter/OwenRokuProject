...
sub GetContent()
    ...
    json = ParseJson(ReadAsciifile("pkg:/assets/Data.json")) ' I got this from https://community.roku.com/t5/Roku-Developer-Program/impoting-data-from-a-json-file/td-p/842063/page/2
    if json <> invalid
